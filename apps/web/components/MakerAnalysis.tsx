...
import { Building2, Tag, Star, TrendingUp, ChevronRight, ChevronDown } from 'lucide-react';
    ...
    <div className={`bg-gray-800 rounded-lg p-6 ${className}`}>
      ...
      {makers.length > 5 && (
        <button
          ...
          className="w-full mt-4 py-2 text-sm text-gray-400 hover:text-white flex items-center justify-center gap-1 transition-colors"
        >
          {isExpanded ? (
            <>
