...
export default function ActressProductFilter({
  ...
  const includeAsps =
    searchParams
      .get('asp')
      ?.split(',')
      .filter((asp) => asp.toUpperCase() !== 'FANZA') || [];
  const excludeAsps =
    searchParams
      .get('excludeAsp')
      ?.split(',')
          ...
          <div>
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
              ...
              <div>
                ...
                <div className="bg-gray-750 -webkit-overflow-scrolling-touch max-h-[280px] space-y-1 overflow-y-auto rounded-lg border border-gray-600 p-2 sm:max-h-72 sm:rounded">
                  {genreTags.map((tag) => (
                    <label
