...
export function DxliveCredit({ className = '', variant = 'small' }: DxliveCreditProps) {
  ...
  if (variant === 'small') {
    return (
      ...
      >
        <div className="min-w-[120px] rounded bg-gradient-to-r from-fuchsia-600 to-purple-600 px-3 py-2 text-center text-sm font-bold text-white transition-all hover:from-fuchsia-500 hover:to-purple-500">
  ...
  return (
    <a
      ...
      aria-label="DXLIVE ライブチャット"
    >
      <div className="rounded-lg bg-gradient-to-r from-fuchsia-600 to-purple-600 p-4 text-center text-white transition-all hover:from-fuchsia-500 hover:to-purple-500">
