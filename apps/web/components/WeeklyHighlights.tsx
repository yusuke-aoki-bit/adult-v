...
export default function WeeklyHighlights({ locale }: WeeklyHighlightsProps) {
  ...
  return (
    <div className="bg-gradient-to-r from-amber-900/30 to-orange-900/30 rounded-xl p-4 sm:p-6 border border-amber-500/20 mb-8">
      {/* Header */}
      <button
                  ...
                  <div className="grid grid-cols-3 gap-2">
                    {data.trendingActresses.slice(0, 3).map((actress) => (
                      <Link
                        ...
                        className="group bg-gray-800/50 rounded-lg overflow-hidden hover:ring-2 hover:ring-amber-500/50 transition-all"
                      >
                  ...
                  <div className="grid grid-cols-3 gap-2">
                    {data.hotNewReleases.slice(0, 3).map((product) => (
                      <Link
                        ...
                        className="group bg-gray-800/50 rounded-lg overflow-hidden hover:ring-2 hover:ring-orange-500/50 transition-all"
                      >
                        ...
                        <div className="p-1.5">
                          <p className="text-white text-xs font-medium line-clamp-2 group-hover:text-orange-300 transition-colors">
                            {product.title}
                          </p>
                        </div>
                      </Link>
                  ...
                  <div className="grid grid-cols-3 gap-2">
                    {data.rediscoveredClassics.slice(0, 3).map((product) => (
                      <Link
                        key={product.id}
                        href={`/${locale}/products/${product.id}`}
                        className="group bg-gray-800/50 rounded-lg overflow-hidden hover:ring-2 hover:ring-rose-500/50 transition-all"
                      >
                        <div className="aspect-[2/3] relative bg-gray-700">
                          {product.imageUrl ? (
                            <Image
                        ...
                        <div className="p-1.5">
                          <p className="text-white text-xs font-medium line-clamp-2 group-hover:text-rose-300 transition-colors">
                            {product.title}
                          </p>
                        </div>
                      </Link>
