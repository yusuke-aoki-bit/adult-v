  ...
  return (
    <div className={`${bgClass} rounded-lg ${className}`}>
      ...
      <button
        ...
        className="w-full flex items-center justify-between py-3 px-4 hover:bg-white/5 rounded-lg transition-colors"
        ...
        <div className="flex items-center gap-2">
          {showClear && isOpen && onClear && (
            <button
              type="button"
              onClick={handleClear}
              className="text-xs text-gray-400 hover:text-red-400 px-2 py-1 rounded hover:bg-gray-700/50 transition-colors"
