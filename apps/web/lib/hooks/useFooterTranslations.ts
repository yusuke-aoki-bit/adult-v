...
export const footerTranslations = {
  ja: {
    ...
    affiliateNotice:
      '当サイトはDUGA、MGS、ソクミル、DTI、B10F.jp、FC2、Japanskaなどのアフィリエイトプログラムに参加しています。商品リンクから購入された場合、紹介料が発生することがあります。',
    disclaimer2257:
  ...
  en: {
    siteName: 'ADULT VIEWER LAB',
    description:
      'Cross-platform adult streaming hub covering DUGA / SOKMIL / DTI with actress-based reviews, rankings, and campaign updates for heavy users.',
    ...
    affiliateNotice:
      'This site participates in affiliate programs with DUGA, MGS, SOKMIL, DTI, B10F.jp, FC2, and Japanska. We may earn commissions from purchases made through product links.',
    disclaimer2257:
  ...
  zh: {
    ...
    affiliateNotice:
      '本站参与DUGA、MGS、SOKMIL、DTI、B10F.jp、FC2和Japanska的联盟计划。通过产品链接购买可能会产生佣金。',
    disclaimer2257:
  ...
  'zh-TW': {
    siteName: 'ADULT VIEWER LAB',
    description: '跨平台成人串流媒體中心，涵蓋DUGA / SOKMIL / DTI，提供女優評論、排行榜和重度使用者活動更新。',
    popularActresses: '人氣女優',
    legal: '網站政策',
    privacy: '隱私權政策',
    terms: '服務條款',
    contact: '聯絡我們',
    ...
    affiliateNotice:
      '本站參與DUGA、MGS、SOKMIL、DTI、B10F.jp、FC2和Japanska的聯盟計畫。透過產品連結購買可能會產生佣金。',
    disclaimer2257:
      '18 U.S.C. § 2257 免責聲明：本站不是任何內容的製作者。所有內容均由第三方平台提供，各平台負責記錄保存合規。',
    admin: '管理頁面',
    copyright: '© {year} Adult Viewer Lab. 保留所有權利。',
  },
  ko: {
    siteName: 'ADULT VIEWER LAB',
    description:
      'DUGA / SOKMIL / DTI를 아우르는 크로스 플랫폼 성인 스트리밍 허브로, 헤비 유저를 위한 여배우 기반 리뷰, 랭킹 및 캠페인 업데이트를 제공합니다.',
    ...
    affiliateNotice:
      '이 사이트는 DUGA, MGS, SOKMIL, DTI, B10F.jp, FC2, Japanska와의 제휴 프로그램에 참여하고 있습니다. 상품 링크를 통한 구매 시 수수료가 발생할 수 있습니다.',
    disclaimer2257:
