...
import { createPublicFavoriteListsGetHandler, createPublicFavoriteListsPostHandler } from '@adult-v/shared/api-handlers';
...
export const POST = createPublicFavoriteListsPostHandler(deps);
