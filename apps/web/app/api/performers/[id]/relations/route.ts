...
export async function GET(
  ...
  try {
    ...
    // キャッシュチェック（v5: 3ホップネットワーク対応）
    const cacheKey = generateCacheKey('relations:web:v5', { performerId, maxHops, limitPerHop });
    ...
    // 3ホップネットワーククエリ
    // hop1: 直接共演者、hop2: 共演者の共演者、hop3: 3ホップ目
