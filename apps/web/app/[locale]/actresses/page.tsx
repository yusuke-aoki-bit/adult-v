...
const translations = {
  ...
  zh: {
    ...
    loading: '加载中...',
    loadMore: '加载更多{count}名',
    allLoaded: '已全部显示（{count}名）',
    loadError: '加载失败',
    retry: '重试',
  ...
  'zh-TW': {
    ...
    loading: '載入中...',
    loadMore: '載入更多{count}名',
    allLoaded: '已全部顯示（{count}名）',
    loadError: '載入失敗',
    retry: '重試',
  ...
  ko: {
    ...
    works: '작품',
    debut: '데뷔',
    noResults: '해당하는 여배우를 찾을 수 없습니다',
    loading: '로딩 중...',
    loadMore: '{count}명 더 보기',
    allLoaded: '모두 표시됨 ({count}명)',
    loadError: '로딩 실패',
    retry: '재시도',
