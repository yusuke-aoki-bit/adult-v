...
export default async function StatisticsPage({
  ...
  return (
    <main className="container mx-auto px-4 py-8 max-w-7xl">
      ...
      {/* ウィジェット埋め込みガイド */}
      <section className="mb-12 bg-indigo-900/20 rounded-lg p-6 border border-indigo-800">
        ...
        <div className="mt-4 p-3 theme-content rounded border theme-border">
          ...
          <ul className="text-xs theme-text-secondary space-y-1">
            <li><code className="bg-gray-700 px-1 rounded">theme=dark</code> - ダークテーマ</li>
            <li><code className="bg-gray-700 px-1 rounded">limit=10</code> - 表示件数（最大10）</li>
          </ul>
        </div>
      </section>
