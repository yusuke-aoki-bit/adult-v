    ...
    <div className="theme-body min-h-screen">
      <section className="scroll-mt-20">
        <main className="container mx-auto max-w-7xl px-4 py-8">
              ...
              <div className="theme-content theme-border overflow-hidden rounded-lg border shadow-sm">
                <table className="w-full">
                  <thead className="bg-gray-700">
                    <tr>
                      <th className="px-4 py-3 text-left text-sm font-medium text-gray-300">順位</th>
                      <th className="px-4 py-3 text-left text-sm font-medium text-gray-300">女優名</th>
                      <th className="px-4 py-3 text-right text-sm font-medium text-gray-300">作品数</th>
                    </tr>
                  </thead>
                  <tbody className="divide-y divide-gray-700">
                    {topPerformers.map((performer, index) => (
                      <tr key={performer.id} className="hover:bg-gray-700/50">
          ...
          {/* ウィジェット埋め込みガイド */}
          <section className="mb-12 rounded-lg border border-indigo-800 bg-indigo-900/20 p-6">
            ...
            <div className="theme-content theme-border mt-4 rounded border p-3">
              ...
              <ul className="theme-text-secondary space-y-1 text-xs">
                <li>
                  <code className="rounded bg-gray-700 px-1">theme=dark</code> - ダークテーマ
                </li>
                <li>
                  <code className="rounded bg-gray-700 px-1">limit=10</code> - 表示件数（最大10）
                </li>
              </ul>
            </div>
          </section>
...
function StatCard({ label, value, suffix }: { label: string; value: string; suffix: string }) {
  return (
    <div className="theme-content theme-border rounded-lg border p-4 shadow-sm">
      ...
      <p className="text-2xl font-bold text-pink-400 md:text-3xl">
        {value}
