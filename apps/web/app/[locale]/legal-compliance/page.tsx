...
export default function LegalCompliancePage() {
  return (
    <div className="theme-body min-h-screen py-12">
        ...
        <div className="space-y-8 rounded-lg bg-gray-800 p-6 text-gray-300 md:p-8">
          ...
          <section className="border-t border-gray-700 pt-6">
            ...
            <div className="space-y-3">
              <div>
                <h3 className="mb-1 text-sm font-medium text-gray-400">現在の状況</h3>
                <p className="leading-relaxed">
                  当サイトは現時点でDMM/FANZAアフィリエイトプログラムに<strong className="text-white">未提携</strong>
                  です。 DMM APIは使用しておらず、アフィリエイトリンクも生成していません。
                </p>
              </div>

              <div>
                <h3 className="mb-1 text-sm font-medium text-gray-400">今後の予定</h3>
                <p className="leading-relaxed">
              ...
              <div>
                <h3 className="mb-1 text-sm font-medium text-gray-400">参考資料</h3>
          ...
          <section className="border-t border-gray-700 pt-6">
            ...
            <div className="space-y-3">
              <div>
                <h3 className="mb-1 text-sm font-medium text-gray-400">利用方法</h3>
                <p className="leading-relaxed">
                  APEXアフィリエイトプログラムに正式登録し、提供されたアフィリエイトIDを使用しています。 商品リンクは
                  click.duga.jp 経由の公式形式で生成しています。
                </p>
              </div>

              <div>
                <h3 className="mb-1 text-sm font-medium text-gray-400">画像利用</h3>
                <p className="leading-relaxed">
                  公式サンプル画像をダウンロードして使用。
          ...
          <section className="border-t border-gray-700 pt-6">
            ...
            <div className="space-y-3">
              ...
              <div>
                <h3 className="mb-1 text-sm font-medium text-gray-400">画像・動画利用</h3>
                <p className="leading-relaxed">
                  サンプル動画・画像は公式提供素材を使用。 規約に基づき、縮小・拡大以外の加工は行っていません。
                </p>
              </div>
          ...
          <section className="border-t border-gray-700 pt-6">
            ...
            <p className="mb-3 text-sm text-gray-400">（カリビアンコム、一本道、HEYZO等）</p>
            ...
            <div className="space-y-3">
              ...
              <div>
                <h3 className="mb-1 text-sm font-medium text-gray-400">法的対応（重要）</h3>
                <div className="rounded-lg bg-gray-900 p-4">
                  ...
                  <ul className="list-inside list-disc space-y-1 text-sm">
                    ...
                    <li>
                      サムネイル画像には<strong className="text-white">ぼかし処理（blur）</strong>を適用しています
                    </li>
          ...
          <section className="border-t border-gray-700 pt-6">
            ...
            <div className="space-y-3">
              <div>
                <h3 className="mb-1 text-sm font-medium text-gray-400">法的根拠</h3>
                <p className="leading-relaxed">
              ...
              <div>
                <h3 className="mb-1 text-sm font-medium text-gray-400">当サイトの対応</h3>
          ...
          {/* 著作権表示 */}
          <section className="border-t border-gray-700 pt-6">
            <h2 className="mb-3 text-xl font-semibold text-white">著作権・帰属表示</h2>
            ...
            <div className="space-y-3">
              ...
              <div className="rounded-lg bg-gray-900 p-4">
                <h3 className="mb-2 text-sm font-medium text-white">画像・コンテンツ提供元</h3>
          ...
          {/* コンプライアンス評価サマリー */}
          <section className="border-t border-gray-700 pt-6">
            <h2 className="mb-4 text-xl font-semibold text-white">コンプライアンス評価サマリー</h2>

            <div className="overflow-x-auto">
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b border-gray-700">
                    <th className="px-3 py-2 text-left text-gray-400">項目</th>
                    <th className="px-3 py-2 text-left text-gray-400">評価</th>
                    <th className="px-3 py-2 text-left text-gray-400">備考</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-gray-700">
                  <tr>
                    <td className="px-3 py-2">DMM/FANZA</td>
                    <td className="px-3 py-2">
                      <span className="text-yellow-400">未提携</span>
                    </td>
                    <td className="px-3 py-2 text-gray-400">申請予定</td>
                  </tr>
                  <tr>
                    <td className="px-3 py-2">DUGA画像利用</td>
                    <td className="px-3 py-2">
                      <span className="text-green-400">準拠</span>
                    </td>
                    <td className="px-3 py-2 text-gray-400">公式サンプル使用</td>
                  </tr>
                  <tr>
                    <td className="px-3 py-2">MGSウィジェット</td>
                    <td className="px-3 py-2">
                      <span className="text-green-400">準拠</span>
                    </td>
                    <td className="px-3 py-2 text-gray-400">公式提供機能</td>
                  </tr>
                  <tr>
                    <td className="px-3 py-2">DTI画像（無修正対応）</td>
                    <td className="px-3 py-2">
                      <span className="text-green-400">準拠</span>
                    </td>
                    <td className="px-3 py-2 text-gray-400">ぼかし処理＋外部参照</td>
                  </tr>
                  <tr>
                    ...
                    <td className="px-3 py-2 text-gray-400">著作権法例外規定適用</td>
                  </tr>
                  <tr>
                    ...
                    <td className="px-3 py-2 text-gray-400">18歳未満アクセス制限</td>
                  </tr>
                </tbody>
              </table>
            </div>
          ...
          {/* お問い合わせ */}
          <section className="border-t border-gray-700 pt-6">
            <h2 className="mb-3 text-xl font-semibold text-white">お問い合わせ</h2>
          ...
          <div className="border-t border-gray-700 pt-6">
            <p className="text-sm text-gray-400">最終更新日: 2024年12月19日</p>
          </div>
        </div>
      </div>
    </div>
