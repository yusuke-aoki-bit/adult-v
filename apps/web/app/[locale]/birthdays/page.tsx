...
const translations = {
  ...
  zh: {
    ...
    subtitle: '查看喜欢的女优的生日',
    todayBirthdays: '今天生日',
    thisWeekBirthdays: '本周',
    thisMonthBirthdays: '本月',
    upcomingBirthdays: '下周',
    noBirthdays: '没有符合条件的女优',
    age: '岁',
    works: '部',
    viewProfile: '查看资料',
    monthlyCalendar: '月历',
  ...
  'zh-TW': {
    ...
    subtitle: '查看喜歡的女優的生日',
    todayBirthdays: '今天生日',
    thisWeekBirthdays: '本週',
    thisMonthBirthdays: '本月',
    upcomingBirthdays: '下週',
    noBirthdays: '沒有符合條件的女優',
    age: '歲',
    works: '部',
    viewProfile: '查看資料',
    monthlyCalendar: '月曆',
  ...
  ko: {
    title: '여배우 생일 캘린더',
    subtitle: '좋아하는 여배우의 생일을 확인하세요',
    todayBirthdays: '오늘 생일',
    thisWeekBirthdays: '이번 주',
    thisMonthBirthdays: '이번 달',
    upcomingBirthdays: '다음 주',
    noBirthdays: '해당하는 여배우가 없습니다',
    age: '세',
    works: '작품',
    viewProfile: '프로필 보기',
