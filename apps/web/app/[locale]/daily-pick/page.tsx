...
const translations = {
  ...
  zh: {
    ...
    threeDaysAgo: '3天前',
    refreshTime: '每天0点更新',
    noPickAvailable: '正在准备今日推荐作品',
    noPickDescription: '请稍候。',
    highlyRated: '高评分作品',
    manyReviews: '评论众多',
    trending: '人气急升',
    starStuddedCast: '豪华阵容',
    aiRecommended: 'AI推荐',
  ...
  'zh-TW': {
    ...
    threeDaysAgo: '3天前',
    refreshTime: '每天0點更新',
    noPickAvailable: '正在準備今日推薦作品',
    noPickDescription: '請稍候。',
    highlyRated: '高評分作品',
    manyReviews: '評論眾多',
    trending: '人氣急升',
    starStuddedCast: '豪華陣容',
    aiRecommended: 'AI推薦',
    prNotice: '本頁面包含廣告與聯盟連結',
  },
  ko: {
    title: '오늘의 추천',
    subtitle: 'AI가 선택한 오늘의 추천 작품',
    todaysPick: '오늘의 픽',
    whySelected: '선정 이유',
    releaseDate: '출시일',
    duration: '수록 시간',
    ...
    twoDaysAgo: '2일 전',
    threeDaysAgo: '3일 전',
    refreshTime: '매일 자정에 업데이트',
    noPickAvailable: '오늘의 추천 작품을 준비 중입니다',
    noPickDescription: '잠시만 기다려 주세요.',
    highlyRated: '높은 평가',
    manyReviews: '리뷰 다수',
    trending: '인기 급상승',
    starStuddedCast: '호화 공연',
    aiRecommended: 'AI 추천',
