    ...
    <div className={`bg-white rounded-lg p-4 shadow ${className}`}>
      ...
      <div className="relative mb-4">
        <input
          ...
          className="w-full px-4 py-3 pl-10 bg-gray-50 text-gray-900 rounded-lg border border-gray-200 focus:border-blue-500 focus:outline-none placeholder:text-gray-400"
        />
      ...
      <button
        ...
        className="w-full py-2 bg-blue-500 hover:bg-blue-600 disabled:bg-gray-300 disabled:cursor-not-allowed text-white rounded-lg flex items-center justify-center gap-2 transition-colors mb-4"
      >
        {isLoading ? (
          <>
        ...
        <div className="mb-4">
          {results.length > 0 ? (
                ...
                {results.slice(0, 6).map(result => (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="text-sm text-gray-700 group-hover:text-blue-500 truncate transition-colors">
                        {result.title}
                      </p>
                    </div>
            ...
            <div className="text-center py-4">
              <p className="text-gray-500 mb-1">{t.noResults}</p>
      ...
      {!hasSearched && recentSearches.length > 0 && (
        <div className="mb-4">
          <div className="flex items-center justify-between mb-2">
            <p className="text-sm text-gray-500">{t.recentSearches}</p>
            <button
      ...
      {!hasSearched && (
        <div>
          <p className="text-sm text-gray-500 mb-2">{t.suggestions}</p>
          <div className="flex flex-wrap gap-2">
            {suggestions.map((suggestion, index) => (
              <button
                ...
                className="px-3 py-1.5 bg-blue-50 hover:bg-blue-100 text-blue-600 text-sm rounded-full transition-colors"
              >
                {suggestion}
              </button>
            ))}
