...
import { ImageLightbox, getActressCardThemeConfig, filterServicesForSite } from '@adult-v/shared/components';

// Theme configuration for apps/fanza (light theme)
const themeConfig = getActressCardThemeConfig('light');
