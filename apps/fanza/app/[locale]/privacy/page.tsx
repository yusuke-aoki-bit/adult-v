...
const metaTranslations = {
  ...
  'zh-TW': {
    title: '隱私權政策 | ADULT VIEWER LAB',
    description: 'ADULT VIEWER LAB的隱私權政策頁面。',
  },
  ko: {
...
const contentTranslations = {
  ja: {
    ...
    section4Text:
      '当サイトはFANZAのアフィリエイトプログラムに参加しています。FANZAでは、ユーザーの行動を追跡するためにCookieを使用する場合があります。詳細については、FANZAのプライバシーポリシーをご確認ください。',
  ...
  en: {
    ...
    section4Text:
      "This site participates in the FANZA affiliate program. FANZA may use cookies to track user behavior. Please refer to FANZA's privacy policy for details.",
  ...
  'zh-TW': {
    title: '隱私權政策',
    section1Title: '1. 個人資訊收集',
    section1Text: '本網站不收集使用者的個人資訊。聯絡我們時可能需要使用電子郵件地址，但我們不收集其他個人資訊。',
    section2Title: '2. Cookie使用',
    section2Text:
      '本網站使用Cookie來改善使用者體驗。Cookie用於年齡驗證和收藏功能等網站功能。您可以在瀏覽器設定中停用Cookie，但某些功能可能無法正常運作。',
    section3Title: '3. 分析工具',
    section3Text1: '本網站使用Google Analytics 4（GA4）來瞭解網站使用情況。GA4使用Cookie匿名收集使用者行為。',
    section3Text2:
      '收集的資訊包括造訪的頁面、停留時間、使用的裝置和大致位置，但不包括可識別個人身份的資訊。IP位址也被匿名化。',
    section3Text3:
      '為符合GDPR/CCPA規定，本網站顯示Cookie同意橫幅。只有當使用者選擇「接受」時，GA4才會啟用。如果選擇「拒絕」，則不會進行GA4追蹤。',
    section3Link: 'Google隱私權政策',
    section4Title: '4. 聯盟行銷計畫',
    section4Text: '本網站參與FANZA的聯盟行銷計畫。FANZA可能使用Cookie來追蹤使用者行為。詳情請參閱FANZA的隱私權政策。',
    section5Title: '5. 免責聲明',
    section5Text: '雖然我們努力確保本網站發佈資訊的準確性，但我們不對使用者基於此資訊採取的任何行動負責。',
    section6Title: '6. 隱私權政策變更',
    section6Text: '本網站可能會不時審查和修改本隱私權政策。任何變更將在本頁面發佈時生效。',
    section7Title: '7. 聯絡方式',
    section7Text: '有關本隱私權政策的諮詢，請透過以下電子郵件地址與我們聯絡。',
  ...
  ko: {
    ...
    section4Text:
      '본 사이트는 FANZA의 제휴 프로그램에 참여하고 있습니다. FANZA는 사용자 행동을 추적하기 위해 쿠키를 사용할 수 있습니다. 자세한 내용은 FANZA의 개인정보 처리방침을 참조하세요.',
