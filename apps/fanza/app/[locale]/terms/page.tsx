...
const contentTranslations = {
  ja: {
    ...
    section3Text: '当サイトは、FANZAのコンテンツ情報を整理し、ユーザーに提供するサービスです。当サイトは情報提供のみを目的としており、コンテンツの販売や配信は行っておりません。',
    section4Title: '4. アフィリエイトについて',
    section4Text: '当サイトはFANZAのアフィリエイトプログラムに参加しており、商品リンクから購入された場合、当サイトに紹介料が発生することがあります。ただし、アフィリエイトリンクの使用によって、ユーザーに追加料金が発生することはありません。',
    section5Title: '5. 著作権・知的財産権',
    section5Text: '当サイトに掲載されているコンテンツ（テキスト、画像、デザインなど）の著作権は、当サイトまたは各権利者に帰属します。商品画像、女優写真などはFANZAから提供されたものであり、それらの著作権は各権利者に帰属します。',
  ...
  en: {
    ...
    section3Text: 'This Site is a service that organizes and provides FANZA content information to users. This Site is intended for information provision only and does not sell or distribute content.',
    section4Title: '4. Affiliate Programs',
    section4Text: 'This Site participates in the FANZA affiliate program. When purchases are made through product links, this Site may receive referral fees. However, using affiliate links does not result in additional charges to users.',
    section5Title: '5. Copyright and Intellectual Property',
    section5Text: 'Copyright for content on this Site (text, images, design, etc.) belongs to this Site or respective rights holders. Product images and performer photos are provided by FANZA, and their copyrights belong to respective rights holders.',
  ...
  zh: {
    ...
    section4Text: '本网站参与FANZA的联盟营销计划。通过产品链接购买时，本网站可能会收到推荐费。但是，使用联盟链接不会向用户收取额外费用。',
    section5Title: '5. 版权和知识产权',
    section5Text: '本网站内容（文字、图片、设计等）的版权归本网站或各权利人所有。产品图片和演员照片由FANZA提供，其版权归各权利人所有。',
  ...
  ko: {
    ...
    section3Text: '본 사이트는 FANZA 콘텐츠 정보를 정리하여 사용자에게 제공하는 서비스입니다. 본 사이트는 정보 제공만을 목적으로 하며, 콘텐츠 판매나 배포는 하지 않습니다.',
    section4Title: '4. 제휴 프로그램',
    section4Text: '본 사이트는 FANZA의 제휴 프로그램에 참여하고 있으며, 상품 링크를 통해 구매할 경우 본 사이트에 소개료가 발생할 수 있습니다. 단, 제휴 링크 사용으로 인해 사용자에게 추가 비용이 발생하지는 않습니다.',
    section5Title: '5. 저작권 및 지적재산권',
    section5Text: '본 사이트에 게재된 콘텐츠(텍스트, 이미지, 디자인 등)의 저작권은 본 사이트 또는 각 권리자에게 귀속됩니다. 상품 이미지, 배우 사진 등은 FANZA에서 제공한 것이며, 그 저작권은 각 권리자에게 귀속됩니다.',
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 md:p-8 space-y-6 text-gray-600">
          ...
          <section>
            ...
            <p className="leading-relaxed mt-3">
              DMCA: <a href="mailto:adult.vvvv@gmail.com" className="text-rose-600 hover:text-rose-500 transition-colors">adult.vvvv@gmail.com</a>
            </p>
          </section>
          ...
          <section>
            <h2 className="text-xl font-semibold text-gray-800 mb-3">{t.section8Title}</h2>
            <p className="leading-relaxed">{t.section8Text}</p>
          </section>

          <section>
            <h2 className="text-xl font-semibold text-gray-800 mb-3">{t.section9Title}</h2>
            <p className="leading-relaxed">{t.section9Text}</p>
          </section>

          <section>
            <h2 className="text-xl font-semibold text-gray-800 mb-3">{t.section10Title}</h2>
            <p className="leading-relaxed">{t.section10Text}</p>
          </section>

          <section>
            <h2 className="text-xl font-semibold text-gray-800 mb-3">{t.section11Title}</h2>
            <p className="leading-relaxed">{t.section11Text}</p>
          </section>

          <section>
            <h2 className="text-xl font-semibold text-gray-800 mb-3">{t.section12Title}</h2>
