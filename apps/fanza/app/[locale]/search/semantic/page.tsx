...
const translations = {
  ja: {
    ...
    howItWorks: '仕組み',
    howItWorksDesc: 'この検索はAIの埋め込みベクトル技術を使用しています。あなたの検索クエリと作品情報を数値ベクトルに変換し、意味的な類似度を計算することで、キーワードが一致しなくても関連性の高い作品を見つけることができます。',
  ...
  en: {
    ...
    howItWorksDesc: "This search uses AI embedding vector technology. By converting your search query and product information into numerical vectors, we can find relevant products even when keywords don't match exactly.",
