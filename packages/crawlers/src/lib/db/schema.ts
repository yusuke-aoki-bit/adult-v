...
export const productSources = pgTable(
  ...
  (table) => ({
    ...
    productTypeIdx: index('idx_sources_product_type').on(table.productType),
    aspProductTypeIdx: index('idx_sources_asp_product_type').on(table.aspName, table.productType),
  }),
);
