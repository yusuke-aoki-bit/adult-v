...
const pageSectionDefaults: Record<string, { ja: HomeSection[]; en: HomeSection[] }> = {
  ...
  discover: {
    ja: [
      { id: 'discover-main', label: '発掘モード', visible: true, order: 0 },
      { id: 'filters', label: 'フィルター', visible: true, order: 1 },
      { id: 'history', label: '履歴', visible: true, order: 2 },
    ],
    en: [
      { id: 'discover-main', label: 'Discover', visible: true, order: 0 },
      { id: 'filters', label: 'Filters', visible: true, order: 1 },
      { id: 'history', label: 'History', visible: true, order: 2 },
    ],
  },
  series: {
    ja: [
  ...
  compare: {
    ja: [
      { id: 'product-search', label: '作品検索', visible: true, order: 0 },
      { id: 'selected-products', label: '選択中の作品', visible: true, order: 1 },
      { id: 'comparison', label: '比較表', visible: true, order: 2 },
    ],
    en: [
      { id: 'product-search', label: 'Product Search', visible: true, order: 0 },
      { id: 'selected-products', label: 'Selected Products', visible: true, order: 1 },
      { id: 'comparison', label: 'Comparison', visible: true, order: 2 },
    ],
  },
};
