...
const themes = {
  dark: {
    ...
    debutIcon: 'flex-shrink-0 w-10 h-10 rounded-full bg-blue-600 flex items-center justify-center',
    latestBadge: 'text-xs text-rose-400 font-medium',
    latestIcon: 'flex-shrink-0 w-10 h-10 rounded-full bg-rose-600 flex items-center justify-center',
    productTitle: 'text-sm text-white truncate group-hover:text-rose-300 transition-colors',
    ...
    barNormal: 'bg-gradient-to-r from-blue-500 to-purple-500',
    barPeak: 'bg-gradient-to-r from-yellow-500 to-orange-500',
    countNormal: 'text-gray-300',
    countPeak: 'text-yellow-400 font-bold',
    productLink: 'text-xs text-gray-500 hover:text-rose-400 truncate max-w-[150px]',
  ...
  light: {
    ...
    debutIcon: 'flex-shrink-0 w-10 h-10 rounded-full bg-blue-500 flex items-center justify-center',
    latestBadge: 'text-xs text-rose-600 font-medium',
    latestIcon: 'flex-shrink-0 w-10 h-10 rounded-full bg-rose-500 flex items-center justify-center',
    ...
    barNormal: 'bg-gradient-to-r from-blue-400 to-purple-400',
    barPeak: 'bg-gradient-to-r from-amber-400 to-orange-400',
