...
export const lightTheme: ThemeConfig = {
  ...
  weeklyHighlights: {
    containerClass: 'bg-gradient-to-r from-amber-200 to-orange-200 rounded-xl p-4 sm:p-6 border border-red-500',
    iconBgClass: 'bg-amber-500/30',
    iconColorClass: 'text-amber-700',
    titleClass: 'text-gray-900',
    subtitleClass: 'text-gray-600',
    chevronClass: 'text-gray-600',
    skeletonBgClass: 'bg-white shadow-sm',
    cardBgClass: 'bg-white border border-gray-200 shadow-sm',
    trendingTitleClass: 'text-amber-800',
    hotTitleClass: 'text-orange-800',
    classicTitleClass: 'text-rose-800',
    cardTextClass: 'text-gray-900',
    cardHoverTextClass: 'group-hover:text-amber-700',
  },
};
