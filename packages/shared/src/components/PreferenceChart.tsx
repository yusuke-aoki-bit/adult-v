...
const themeConfig = {
  dark: {
    ...
    dataFill: 'rgba(217, 70, 239, 0.3)',
    dataStroke: 'rgb(217, 70, 239)',
    pointFill: 'rgb(217, 70, 239)',
    labelClass: 'fill-gray-300',
    valueClass: 'fill-fuchsia-400',
    emptyText: 'text-gray-500',
    barLabelClass: 'text-gray-300',
    barValueClass: 'text-fuchsia-400',
    barBgClass: 'bg-gray-700',
    barFillClass: 'bg-linear-to-r from-fuchsia-600 to-fuchsia-400',
  },
  light: {
