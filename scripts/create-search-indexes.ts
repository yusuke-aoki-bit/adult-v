...
async function createIndexes() {
  ...
  try {
    ...
    await db.execute(sql`CREATE INDEX IF NOT EXISTS idx_performers_name_trgm ON performers USING gin (name gin_trgm_ops)`);
    await db.execute(sql`CREATE INDEX IF NOT EXISTS idx_performers_name_kana_trgm ON performers USING gin (name_kana gin_trgm_ops)`);
    ...
    await db.execute(sql`CREATE INDEX IF NOT EXISTS idx_performer_aliases_performer_id ON performer_aliases (performer_id)`);
    await db.execute(sql`CREATE INDEX IF NOT EXISTS idx_performer_aliases_alias_name_trgm ON performer_aliases USING gin (alias_name gin_trgm_ops)`);
    await db.execute(sql`CREATE INDEX IF NOT EXISTS idx_performer_aliases_alias_name ON performer_aliases (alias_name)`);
    ...
    await db.execute(sql`CREATE INDEX IF NOT EXISTS idx_product_performers_performer_id ON product_performers (performer_id)`);
    await db.execute(sql`CREATE INDEX IF NOT EXISTS idx_product_performers_product_id ON product_performers (product_id)`);
    await db.execute(sql`CREATE INDEX IF NOT EXISTS idx_product_performers_composite ON product_performers (performer_id, product_id)`);
    ...
    await db.execute(sql`CREATE INDEX IF NOT EXISTS idx_product_sources_asp_name_product_id ON product_sources (asp_name, product_id)`);
